...
async def aget_embedding(
    ...
    return (await client.embeddings.acreate(input=[text], engine=engine, **kwargs))["data"][0][
        "embedding"
    ]
...
async def aget_embeddings(
    ...
    data = (await client.embeddings.acreate(input=list_of_text, engine=engine, **kwargs)).data
    return [d["embedding"] for d in data]
